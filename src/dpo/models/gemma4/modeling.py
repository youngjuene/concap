...
Everything here is runtime shape: the quantized base, the processor, the k-bit
training preparation, and the guard that keeps every trainable parameter inside
the text language model.
"""
